...
class Client {
  ...
  Client(this._id,this._nome, this._contato_funcao,this._contato_nome,this._cgc_cpf,
         this._inscr_estadual,this._endereco, this._cidade,this._estado,this._cep,
         this._telefone1,this._telefone2,this._telefone3,this._email,this._obs,
         this._preco_base);
